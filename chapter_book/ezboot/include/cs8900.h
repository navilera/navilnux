...
#ifndef _CS8900_HEADER_
#define _CS8900_HEADER_

// IO Mapped Packet Page.
#define	CS8900_BASE		( DEFAULT_nCS_CS8900_BASE + 0x300 )
#define CS8900_RTX_DATA		*((volatile short *)(CS8900_BASE + 0x00000000))	// RTx data.
#define CS8900_TXCMD		*((volatile short *)(CS8900_BASE + 0x00000004))	// RTx command.
#define CS8900_TXLEN		*((volatile short *)(CS8900_BASE + 0x00000006))	// transmit length.
#define CS8900_ISQ		*((volatile short *)(CS8900_BASE + 0x00000008))	// interrupt.
#define CS8900_PPPTR		*((volatile short *)(CS8900_BASE + 0x0000000a))	// packet page point.
#define CS8900_PPDATA		*((volatile short *)(CS8900_BASE + 0x0000000c))	// packet page data.

#define	CS8900_ENABLE_WORD	(*((volatile char *)(CS8900_BASE + 0x00000001)) = 0 )	// CS8900 WORD Enable

#define CS8900_DECTECT_MASK     	0x00003000        // CS8900 검출 MASK PATTERN                  
                                       
#define PP_ChipID_HIGH			0x0000	  // First  Chip ID. CS8900A : 0x630E
#define PP_ChipID_LOW			0x0002	  // Second Chip ID. CS8900A : 0x0800

#define CHECK_CHIP_ID_HIGH              0x0E63
#define CHECK_CHIP_ID_LOW               0x0900
...
#define INTRQ_HIGH_IMPEDENCE		0x0004
...
#define DMRQ1				0x0001
#define DMRQ2				0x0002
#define DMRQ_HIGH_IMPEDENCE		0x0003
...
// 이더넷 디폴트 어드레스 
//
extern BOOL  CS8900_Init( void );                    // CS8900 칩을 초기화 한다. 
extern Byte *CS8900_GetMacAddress( void );           // 초기화된 CS8900의 맥 어드레스를 얻는다.  
extern BOOL  CS8900_CheckLink( void );               // CS8900이 네트워크에 링크 되어 있는가를 확인한다. 
extern BOOL  CS8900_Transmit( void *txPktBuf, int len );
extern int CS8900_Resive(void *rxPktBuf, int max_size );

// BOOL	EthInit();			// Initialize the device.
// int	EthTx(void *pkt, int len);	// Send a packet.
// int	EthRx(void *pkt);		// Check for received packets.
// void	EthHalt(void);			// stop SCC.
// void	EthRestart(void);		// restart scc.

extern void  CS8900_SwReset( void );

#endif		// _CS8900_HEADER_
